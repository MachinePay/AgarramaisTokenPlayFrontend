      ...
      <div className="w-full max-w-sm rounded-t-3xl bg-white sm:rounded-3xl">
        {step === "confirm" && (
          <div className="flex flex-col gap-5 px-6 py-6">
            ...
            <button
              ...
              className="w-full rounded-xl bg-brand-yellow py-3.5 text-base font-bold text-brand-black transition-opacity disabled:opacity-40"
            >
        ...
        {step === "success" && result && (
          <div className="flex flex-col items-center gap-4 px-6 py-10">
            ...
            <p className="text-center text-base font-bold text-brand-black">Jogada liberada!</p>
            ...
            <button
              ...
              className="w-full rounded-xl bg-brand-yellow py-3.5 text-base font-bold text-brand-black"
            >
              Fechar
            </button>
          </div>
        ...
        {step === "error" && (
          <div className="flex flex-col items-center gap-4 px-6 py-10">
            ...
            <button
              ...
              className="w-full rounded-xl border border-brand-black py-3.5 text-base font-bold text-brand-black"
            >
              Tentar novamente
            </button>
          </div>
